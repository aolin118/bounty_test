                    ...
                    <div class="col-12 col-lg-9 mx-auto step-container">
                        <div class="card border-0 mb-3 h-100">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p><input type="checkbox" id="interestCheckBox" name="interestCheckBox" onclick="registerInterest();"> Yes, I am interested in getting early access to BCoin’s Prepaid Debit Card and have registered for an account at BCoin.sg Exchange.</p>
