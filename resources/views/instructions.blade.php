                    ...
                    <div class="col-12 col-lg-9 mx-auto step-container">
                        <div class="card border-0 mb-3 h-100">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p><input type="checkbox" id="interestCheckBox" name="interestCheckBox" onclick="registerInterest();"><small class="ml-2">Yes, I am interested in getting early access to BCoin’s Prepaid Debit Card and have registered for an account at <a href="https://www.bcoin.sg/" target="_blank">BCoin.sg</a> Exchange.</small></p>
